...
// Rate tracks the rate of item frequencies with exponential decay.
// Unlike Sketch which provides frequency counts, Rate tracks how quickly
// item frequencies are changing over time.
//
// Use cases:
